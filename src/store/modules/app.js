 ...
 * @LastEditors: 王欣磊
 * @LastEditTime: 2021-06-08 12:02:50
 * @Description:
 * @FilePath: /ship-face/src/store/modules/app.js
 */
/*
 * @Author: 王欣磊
 * @Date: 2021-03-13 09:24:52
 * @LastEditors: 王欣磊
 * @LastEditTime: 2021-03-16 17:54:17
 * @Description:
 * @FilePath: /ship-face/src/store/modules/app.js
 */
...
const app = {
  state: {
    ...
    lang: 'zh-CN',
    _antLocale: {},
    domTitle: defaultSettings.title
  },
  mutations: {
    ...
    [DOM_TITLE_ITEM]: (state, item) => {
      storage.set(DOM_TITLE_ITEM, item)
      state.domTitleItem = item
    },
    [DOM_TITLE]: (state, title) => {
      storage.set(DOM_TITLE, title)
      state.domTitle = title
    }
  },
  actions: {
    setLang ({ commit }, lang) {
